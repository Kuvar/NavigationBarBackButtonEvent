...
using System.Linq;
using System.Text;
using BackButtonClick;
using BackButtonClick.iOS.Renderers;
using CoreGraphics;
using Foundation;
using UIKit;
using Xamarin.Forms;
...
[assembly: ExportRenderer(typeof(ExtendedContentPage), typeof(ContentPageRenderer))]
namespace BackButtonClick.iOS.Renderers
{
    public class ContentPageRenderer : PageRenderer
    {
        public override void ViewWillAppear(bool animated)
        {
            ...
            if (((ExtendedContentPage)Element).EnableBackButtonOverride)
            {
                SetCustomBackButton();
            }
        }
        ...
        private void SetCustomBackButton()
        {
            ...
            backBtn.TouchDown += (sender, e) =>
            {
                ...
                if (((ExtendedContentPage)Element)?.CustomBackButtonAction != null)
                {
                    ((ExtendedContentPage)Element)?.CustomBackButtonAction.Invoke();
                }
            };
